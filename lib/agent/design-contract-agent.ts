...
2. Application / IDE / dashboard UI (Cursor, authenticated product chrome) → do NOT rely on the marketing homepage crawl. Ask for or use an attached screenshot and call contract_from_screenshot (web-app default). Public scans of cursor.com etc. are marketing surfaces.
...
- contract_from_screenshot: APPLICATION Design Contract from a product UI screenshot (vision). Prefer for app/IDE UIs; defaults to web-app.
