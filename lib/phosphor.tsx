...
export const FileTextIcon = duotone(P.FileTextIcon)
export const FloppyDiskIcon = duotone(P.FloppyDiskIcon)
...
export const PencilSimpleIcon = duotone(P.PencilSimpleIcon)
export const PlusIcon = duotone(P.PlusIcon)
export const SlidersHorizontalIcon = duotone(P.SlidersHorizontalIcon)
export const SparkleIcon = duotone(P.SparkleIcon)
export const SquareIcon = duotone(P.SquareIcon)
export const StackIcon = duotone(P.StackIcon)
export const SwapIcon = duotone(P.SwapIcon)
...
export const LockIcon = duotone(P.LockIcon)
export const PenNibIcon = duotone(P.PenNibIcon)
