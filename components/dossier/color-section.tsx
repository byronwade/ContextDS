  ...
  return (
    <span
      className={cn(
        ...
        grade === 'AAA' && 'border-[oklch(0.72_0.12_165/0.4)] text-[oklch(0.72_0.12_165)]',
        grade === 'AA' && 'border-[oklch(0.72_0.12_165/0.3)] text-[oklch(0.72_0.12_165/0.85)]',
        grade === 'AA18' && 'border-[oklch(0.8_0.12_85/0.4)] text-[oklch(0.8_0.12_85)]',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected
          ? 'z-10 -my-1 rounded-lg ring-2 ring-[oklch(0.78_0.08_185)] ring-offset-2 ring-offset-background'
