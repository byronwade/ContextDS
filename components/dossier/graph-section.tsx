    ...
    return (
      ...
      >
        <rect
          ...
          stroke={
            hoverId === node.id
              ? 'color-mix(in oklab, var(--ui-accent) 80%, transparent)'
              : node.kind === 'role'
                ? 'color-mix(in oklab, var(--ui-accent) 35%, transparent)'
        ...
        <text
          ...
          fill={node.kind === 'role' ? 'var(--ui-accent)' : 'var(--foreground)'}
        >
            ...
            {model.visibleEdges.map((edge) => {
              ...
              return (
                <path
                  ...
                  fill="none"
                  stroke={
                    isHot ? 'color-mix(in oklab, var(--ui-accent) 90%, transparent)' : 'color-mix(in oklab, var(--ui-accent) 18%, transparent)'
                  }
