        ...
        {system.valuesPx.slice(0, 14).map((value) => (
          ...
          >
            ...
            <span className="h-4 flex-1">
              <span
                className={cn(
                  'block h-full rounded-r-sm bg-foreground/25 transition-colors group-hover:bg-[oklch(0.78_0.08_185/0.5)]',
                  system.base && value % system.base !== 0 && 'bg-[oklch(0.8_0.12_85/0.35)]'
                )}
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3">
        {system.radiiPx.slice(0, 8).map((radius) => (
          ...
          >
            <span
              className="block size-16 border border-border/80 bg-secondary/40 transition-colors group-hover:border-[oklch(0.78_0.08_185/0.6)] group-hover:bg-secondary/70"
        ...
        {system.durationsMs.slice(0, 5).map((duration) => (
          <div key={duration} className="flex items-center gap-3">
            ...
            <span className="relative h-5 flex-1 overflow-hidden rounded-full bg-secondary/40">
              <span
                key={runKey}
                className="absolute left-0 top-1/2 size-3 -translate-y-1/2 rounded-full bg-[oklch(0.78_0.08_185)]"
                style={{
